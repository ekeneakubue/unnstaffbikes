...
import type { AdminFormState } from "@/lib/admin/station-actions";
...
export default function AddUnitForm({
  ...
  return (
    <form action={formAction} className="space-y-4">
      <div>
        <label htmlFor="unitName" className="mb-1.5 block text-sm font-medium text-[#0f2419]">
          Station name
        </label>
        <input
          id="unitName"
